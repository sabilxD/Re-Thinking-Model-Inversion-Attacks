...
**Few of the images generated by our inversion attacks compared to the original image in the private dataset**

<img src="cropped_faces/Comparison.png" alt="Alt text" width="70%" height="60%">


**Top 1 and Top 5 Accuracy of the variants we teseted**

<img src="cropped_faces/Results.png" alt="Alt text" width="80%" height="70%">
